...
int main(void) { 
	...
	filconverter1("Inputfile1.txt","Outputfile1.txt");
	filconverter2("Inputfile2.txt","Outputfile2.txt");
	filconverter3("Inputfile3.txt","Outputfile3.txt");
	filconverter4("Inputfile4.txt","Outputfile4.txt");
}
